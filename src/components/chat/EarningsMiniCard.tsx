...
export function EarningsMiniCard({ delta, revenue, expenses, completed, profit }: Props) {
  return (
    <div
      className="self-start w-[min(360px,90%)] ml-[37px] bg-white border border-line rounded-[6px_20px_20px_20px] p-4 shadow-[0_1px_10px_rgba(34,27,30,0.06)]"
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-[9px]">
        <div className="bg-plum-soft border border-plum/10 rounded-[13px] p-[11px_13px]">
